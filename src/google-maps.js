 ...
 *
 * Used only as a fallback when Apple MapKit is unavailable. The API key is
 * fetched at runtime so deployments can use different referrer-restricted
 * keys without compiling credentials into the bundle.
 */
