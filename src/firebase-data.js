    ...
    (snap) => {
      ...
      snap.forEach((d) => {
        ...
        map.set(d.id, {
          ...
          opsDisposition: data.opsDisposition || 'monitoring',
          opsDispositionReason: data.opsDispositionReason || '',
          opsUpdatedAt: data.opsUpdatedAt || null,
          opsUpdatedByName: data.opsUpdatedByName || '',
          opsLatestNote: data.opsLatestNote || '',
          opsLatestNoteAt: data.opsLatestNoteAt || null,
